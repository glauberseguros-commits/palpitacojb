...
export const TERNO_GRUPO_RANKING_VERSION =
  "TERNO_GRUPO_V3_HISTORICAL_COMBINATION";
...
function uniqueTop5Groups(draw) {
  const seen = new Set();
  const groups = [];
...
function buildHistoricalStats({
  ...
  draws.forEach((draw, index) => {
    const groups = uniqueTop5Groups(draw);
